...
$sqlinsert = " INSERT INTO Industry (CompName,Owner,AuthSign,CR,Activity,CompanyType,State,District,City,Street,Building,Telephone,Fax,POBOX,Website,Email) VALUES ('$cname','$owner','$NameA','$CR','$Act','$CompType','$State','$Dist','$City','$Street','$Build','$Tel','$Fax','$POBox','$Web','$Email')";
...
<h1>Industry</h1>
<form method="post" action="add-ind.php" >
<input type="hidden" name="submitted" value="true" />
<fieldset>
<legend>Basic Info</legend>
<table>
<tr><label><td>Company Name:</td><td><input type="text" name="CName" style="background-color:#F2F5A9" required/></td> </label></tr>
<tr><label><td>Owner:</td><td><input type="text" name="Owner" style="background-color:#F2F5A9" required/> </td></label></tr>
<tr><label><td>Name of the Authorized to Sign:</td><td><input type="text" name="NameAut" style="background-color:#F2F5A9" required/></td> </label></tr>
<tr><label><td>CR:</td><td><input type="text" name="CR" /> </td></label></tr>
<tr><label><td>Activity:</td><td><input type="text" name="Activity" style="background-color:#F2F5A9" required /> </td></label></tr>
<tr><label><td>Company Type</td><td><select name="Comp_Type">
<option value="Individual Company">Individual Company</option>
<option value="Partnership Limited By Shares">Partnership Limited By Shares</option>
<option value="General Partnership">General Partnership</option>
<option value="Limited Partnership">Limited Partnership</option>
<option value="Holding">Holding</option>
<option value="Limited Liability (SARL)">Limited Liability (SARL)</option>
<option value="Joint Stock (SAL)">Joint Stock (SAL)</option>
</select></td></tr>
</table></fieldset>
<fieldset>
