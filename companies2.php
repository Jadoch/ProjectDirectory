...
<p align=center>This page purpose is to unselect the companies</br> that i don't want them to be shown no more on my website 
...
if(isset($_POST[show]) && $_POST[show]=='no'){
...
echo "<form action=companies2.php method=post>";
echo "<tr>";
...
echo "<td>"."<input type=checkbox name=show value='no'>"."</td>";
...
if(isset($_POST[show2]) && $_POST[show2]=='no'){
...
echo "<td>".$rec['Email']."</td>";
echo "<td>".$rec['Submit']."</td>";
echo "<td>"."<input type=checkbox name=show2 value='no'>"."</td>";
