...
$sqlinsert = " INSERT INTO Insurance (InsuranceName,CR,Capital,CEO,State,District,City,Street,Building,Telephone,Fax,POBOX,Website,Email) VALUES ('$cname','$CR','$Capital','$CEO','$State','$Dist','$City','$Street','$Build','$Tel','$Fax','$POBox','$Web','$Email')";
...
<h1>Insurance</h1>
<form method="post" action="add-ins.php" >
<input type="hidden" name="submitted" value="true" />
<fieldset>
<legend>Basic Info</legend>
<table>
<tr><label><td>Insurance Company Name:</td><td><input type="text" name="CName" style="background-color:#F2F5A9" required/></td> </label></tr>
