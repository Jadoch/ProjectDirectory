...
$sqlinsert = " INSERT INTO Importers (ImpName,Owner,CR,Activity,State,District,City,Street,Building,Telephone,Fax,POBOX,Website,Email) VALUES ('$cname','$owner','$CR','$Act','$State','$Dist','$City','$Street','$Build','$Tel','$Fax','$POBox','$Web','$Email')";
...
<h1>Importer</h1>
<form method="post" action="add-imp.php" >
