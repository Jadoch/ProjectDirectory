...
<table border=1 align=center style="background-image:url(background2.jpg)";>
<tr><td>
...
$sqllist = "SELECT * FROM Industry where Submit='yes'";
$indlistdata = mysql_query($sqllist,$accounts);
echo "<table border=1><tr>
<th>Company</th><th>District</th><th>City</th><th>Telephone</th><th>Email</th>
</tr>
";
while ($indrecord = mysql_fetch_array($indlistdata)){
$val;
echo "<form method='post' action='list_ind.php'	>";
echo "<tr>";
echo "<td>".$indrecord['CompName']."</td>";
echo "<td>".$indrecord["District"]."</td>";
echo "<td>".$indrecord['City']."</td>";
echo "<td>".$indrecord['Telephone']."</td>";
echo "<td>".$indrecord['Email']."</td>";
echo "<td><a href=\"ind-details.php?whatever=".$indrecord['Comp_id']."\" >Details</a></td>";
echo "</tr>";
echo "</form>";
}
